<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action=" {{ route('transaction.post', ['account_id' => $account->id_account]) }}">
            ...
            <input type="hidden" name="credit_left" value="{{ $credit_left }}">
            <input type="hidden" name="credit_amount" value="{{ $credit_amount }}">
            <input type="hidden" name="total_rates" value="{{ $total_rates }}">
            <input type="hidden" name="end_credit" value="{{ $end_credit }}">
            <input type="hidden" name="one_rate" value="{{ $one_rate }}">
            <input type="hidden" name="id" value="{{ $id_credit }}">
