...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'FMMKParibas') }}</title>
        ...
        <footer class="text-center lg:text-left bg-gray-200 text-gray-600">
            <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div class="flex justify-center">
                    <a href="https://github.com/matduszek/laravel-bank-app" class="text-gray-600">
          ...
          ">
                        ...
                        <p class="text-justify">
                            Bank FMMKParibas to jeden z największych banków na świecie.
                            W Polsce bank oferuje szeroki zakres usług finansowych dla klientów indywidualnych,
                            firm oraz instytucji. Oferta obejmuje m.in. konta osobiste i firmowe, karty kredytowe,
                            kredyty, ubezpieczenia oraz usługi finansowe dla przedsiębiorstw.
                    ...
                    <div class="">
                        ...
                        <p class="mb-4">
                            <a href="{{ route('show.investmentinfo') }}" class="text-gray-600">LOKATY</a>
                        </p>
                    </div>
                    <div class="">
                        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                        ...
                        <p class="flex items-center justify-center md:justify-start mb-4">
                            ...
                            <a href="{{ route('show.officeinfo') }}" class="text-gray-600">Jelenia Góra, Plac Piastowski 26, PL</a>
                        </p>
                        <p class="flex items-center justify-center md:justify-start mb-4">
