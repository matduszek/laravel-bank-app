                    ...
                    <div class="bg-gray-200 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="bg-blue-200 overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <div class="p-6 text-gray-900">
                                ...
                                <center><div class="mt-3 mb-3">{!! DNS2D::getBarcodeHTML("$t->qrcode", 'QRCODE') !!}</div></center>
                                <div class="text-center mt-3 text-2xl"><label>Koniec ważności: {{ $t->end_time }}</label></div>
                            </div>
